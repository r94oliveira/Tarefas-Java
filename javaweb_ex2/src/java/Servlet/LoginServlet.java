...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if(!(usuario.isEmpty()) && usuario.equals(senha) ){
                out.println("Usuário logado com sucesso! Seja bem vindo(a) " + usuario + ". <br>");
                out.println("<a href='./PortalServlet'>Acessar Portal</a>");
            } else {
                out.println("O login/senha não existem ou estão incorretos.<br>");
